...
- Keine der rund 40 untersuchten Apps erfüllt die Kombination "täglich per Sprache, ausnahmslos lokal, kein Konto, iOS und Android, Deutsch als vollwertige Sprache". Plattformübergreifend sind die drei nächsten Kandidaten CortexOS (KI-Analyse-Journal mit Cloud-Vault im Premium), Offscript (Sprachmemo-Werkzeug ohne Tagebuch-Ritual) und Flint (Standardmodus schickt Text in die Cloud) [1][2][3]. Auf iOS allein ist DailyVox seit August 2026 der nächste Wettbewerber: kostenlos, MIT-lizenziert, seit v1.10.0 mit Deutsch und seit v1.11.0 ohne jeden Cloud-Fallback; eine Android-Version gibt es nicht, die Nachfrage danach ist im Issue-Tracker dokumentiert [13][62][63].
...
Brückenkopf: **Android-Nutzer im DACH-Raum, die ein privates Sprach-Tagebuch ohne Google-Konto wollen.** Zweiter Ring: **iPhone-Nutzer in Mischhaushalten und Umsteiger von Apple Journal.** Begründung in Abschnitt 8. Plattformübergreifend liegt der Unterschied in Android; auf iOS, wo DailyVox Deutsch und vollständige Lokalität bereits kostenlos bietet, liegt er in der Verschlüsselung auf dem Gerät, im Backup und QR-Gerätewechsel, in der Erinnerungslogik und in der Produktreife [62]. Der QR-Gerätewechsel, das verschlüsselte Backup und der Export sind Vertrauensbeweise, die diese Positionierung stützen; sie sind keine Schlagzeile, weil niemand danach sucht.

## 2. Methodik und Quellenlage

Die Recherche lief am 3. September 2026 über Websuche mit Snippet-Auswertung. App Store, Google Play und die meisten Herstellerseiten waren aus der Recherche-Umgebung nicht abrufbar (D15). Direkt gelesen wurden GitHub-Repositories (DailyVox, WhisperJournal, VoiceInk, Konverter-Projekte) und developer.apple.com. Eine Nachrecherche zu Nutzerstimmen und Store-Kennzahlen (`docs/recherche/nachrecherche-nutzerstimmen-stores.md`) hat die Store-Sperre bestätigt, aber 66 quellenzugeordnete Belege geliefert, darunter neun echte deutschsprachige Rezensionsfragmente, vom Entwickler archivierte Play-Store-Rezensionen und den aktuellen Stand von DailyVox; sie ist in den Abschnitten 4, 5, 6, 8 und 9 eingearbeitet [62].

Faktenprüfung (`docs/recherche/verifikation.json`, Stand 3. 9. 2026: 30 Aussagen, 18 bestätigt, 12 präzisiert) eingearbeitet; präzisierte Aussagen sind in der dortigen Fassung übernommen. Die geprüften Aussagen betreffen die Technikberichte zu iOS und Android; für dieses Dokument relevant sind die Bestätigung, dass SpeechTranscriber vollständig auf dem Gerät arbeitet und die Modelle vom System nachgeladen und gepflegt werden (Grundlage der Sherlocking-Einschätzung in Abschnitt 7), und die Präzisierung zu den Apple-Locales (Tabelle 4.2, Diarly: Apple veröffentlicht keine feste Liste, `supportedLocales` ist zur Laufzeit abzufragen, und die Ausgabe war über die iOS-26.x-Versionen nicht stabil). Marktzahlen waren nicht Gegenstand der Prüfung, und auch die Nachrecherche konnte keine Store-Seite direkt abrufen [62]. **Alle Preise, Sternebewertungen, Download- und Nutzerzahlen in den Tabellen stammen daher weiterhin aus Suchsnippets und gelten als unverifiziert**, bis sie gegen die Store-Seiten geprüft sind. Im Fließtext ist dies je Zahl mit "(unverifiziert)" markiert; die Kennzeichnung gilt für alle Aussagen, die nicht in `verifikation.json` stehen. Preise sind US-Dollar-Angaben der Quellen; DACH-Preise in Euro weichen ab. Mehrere "Review 2026"-Seiten werden von Wettbewerbern betrieben (reflection.app, mindsera.com, dayora.ai, spokenly.app) und wurden nur herangezogen, wo keine bessere Quelle vorlag.
...
| DailyVox (K. NG, MIT) [13][33][62][63] | iOS 17+; kein Android (Stand Sept. 2026; Nutzeranfrage nach Android im Issue-Tracker vom 3. Aug. 2026, keine Ankündigung) | kostenlos, Open Source, keine In-App-Käufe ("Free forever") | 100 % lokal, "Data Not Collected"; seit v1.11.0 (Aug. 2026) kein Cloud-Fallback mehr: ohne lokales Modell stoppt die App; optional iCloud-Sync; AES-256-Backup; Verschlüsselung der Einträge auf dem Gerät nicht belegt | OD (Apple Speech), Live-Transkription | EN; DE, ES, FR, IT seit v1.10.0 (Aug. 2026) | iCloud optional; Export PDF/JSON/Markdown/CSV | 42-Sekunden-Einträge, Wochenziele, Widgets, Siri | kein Android; kostenloser, deutschsprachiger, vollständig lokaler Wettbewerber auf iOS (Preisanker 0 €); Solo-Projekt; kein Gerätewechsel ohne iCloud, keine tägliche Erinnerung zur Uhrzeit belegt |
...
Weitere Android-Listings ohne belastbare Daten: Voice Diary (60-Sekunden-Einträge, "100 % offline AI"), AI Offline Voice Journal/WhisperJournal (MIT, whisper.cpp, rund 1 100 Downloads laut AppBrain, unverifiziert), TalkJournal (Face ID, Kalenderansicht) [49][50][51]. Die Nachrecherche hat drei weitere Listings ohne belastbare Daten ergeben: Murmeln: Sprachtagebuch (iOS DE-Store und Play, deutschsprachig), Memex (iOS und Play, lokal-first Multimodal-Journal mit eigenem LLM-Anschluss, Transkriptions-Engine nicht dokumentiert) und OpenTranscribe (iOS, MIT, vollständig auf dem Gerät, freiwilliger Unterstützerkauf) [62]. appshunter.io zählt "226+ Voice Diary Apps for iPhone" [52]; das Segment ist zahlreich, aber flach besetzt.
...
**DailyVox** ist seit August 2026 der nächste Wettbewerber auf iOS: Mit v1.10.0 kamen Deutsch, Spanisch, Französisch und Italienisch hinzu, mit v1.11.0 wurde der Cloud-Fallback vollständig entfernt (ohne lokales Modell stoppt die App, statt Audio an Server zu schicken) [13][62]. Damit existiert auf iOS ein kostenloser, MIT-lizenzierter, deutschsprachiger und vollständig lokaler Wettbewerber mit "Data Not Collected"-Label. Er beweist, dass Apples On-Device-Stack dafür reicht, und dass Android der schwierigere Teil ist: Eine Android-Version gibt es nicht; die Nachfrage ist im Issue-Tracker dokumentiert (Issue #4, 3. August 2026), eine Ankündigung des Entwicklers nicht [63]. Der Unterschied zur App liegt auf iOS deshalb nicht im Datenschutzversprechen, sondern in der Verschlüsselung der Einträge auf dem Gerät (bei DailyVox ist nur ein AES-256-Backup belegt), im verschlüsselten Backup und QR-Gerätewechsel (D5, D6), in der Erinnerungslogik (tägliche Uhrzeit ohne Streak-Druck statt Wochenziele, D7) und in der Produktreife (Solo-Projekt, 42-Sekunden-Einträge, Analyse-Beiwerk "Digital Twin"); plattformübergreifend liegt er in Android. Als kostenloses Open-Source-Produkt setzt DailyVox auf iOS den Preisanker auf null.
...
**Apple Journal** bleibt der Maßstab für Einfachheit und Preis. Seine drei Grenzen sind zugleich die Differenzierungsflächen der App: kein Android, keine deutsche Transkription (Stand Support-Dokumentation, am Gerät zu prüfen), kein Weg aus iCloud heraus außer einem HTML-ZIP [4][5][17][18]. Hinzu kommt ein vierter Punkt, den Nutzer selten sehen: Apple Journal legt Einträge lokal als RTF in einer unverschlüsselten SQLite-Datenbank ab (Befund eines Kommandozeilenwerkzeugs, das direkt in diesen Datenspeicher schreibt); die eigene Verschlüsselung auf dem Gerät (D5) ist damit auch gegenüber dem Systemstandard ein prüfbarer Unterschied [64].
...
| Android | nein | nur Pixel | ja | nein | nein (Nachfrage dokumentiert) | ja | ja | ? | ja | ja |
| Transkription immer lokal | ja | ja | teilw. (nur iOS 26 + Apple Intelligence) | ja (iOS 26) | ja | ja | ja | teilw. (Option) | ja | ja |
| Deutsch transkribiert | nein | ja | ja (Server/OD) | ja | ja (seit v1.10.0) | ja | ja | ? | nein | ja |
| Kein Konto, keine Server | teilw. (iCloud) | teilw. (Backup optional) | nein | teilw. (iCloud) | ja (seit v1.11.0 ohne Cloud-Fallback) | teilw. (Cloud-Vault im Premium) | ja | teilw. | ja | ja |
...
3. **Kein Konto ist im Mainstream unbesetzt.** Alle plattformübergreifenden Tagebuch-Apps mit Transkription verlangen ein Konto; alle kontofreien Apps sind Einzelplattform, auf iOS seit August 2026 auch kostenlos und deutschsprachig (DailyVox) [9][11][13][62].
...
**Sherlocking.** Apple hat Journal im September 2025 auf iPad und Mac gebracht und mit iOS 26 SpeechAnalyzer/SpeechTranscriber als System-API veröffentlicht [16][17]. Damit sinkt die Eintrittshürde für Apple-only-Apps (Diarly nutzt das Modell bereits; DailyVox liefert damit seit August 2026 Deutsch kostenlos und ohne Cloud-Fallback [12][62]), während Android weiter eine eigene Engine braucht. Für die App bedeutet das: Der iOS-Teil ist technisch günstig (D2), die Differenzierung liegt auf Android und im plattformübergreifenden, serverlosen Gesamtpaket.
...
2. Auf iOS konkurriert die App mit einem vorinstallierten, kostenlosen Apple Journal, das dieselbe System-Engine nutzt wie Notizen und Sprachmemos; letztere transkribieren Deutsch bereits lokal [4][16]. Dass Journal selbst laut Support-Dokumentation nur Englisch transkribiert, kann Apple mit einem Punkt-Update ändern. Und DailyVox hat den Schritt bereits getan: kostenlos, Open Source, Deutsch seit v1.10.0, ohne Cloud-Fallback seit v1.11.0 [13][62]. Der iOS-Vorsprung bei "lokal und deutsch" ist also geliehen beziehungsweise schon aufgebraucht; was auf iOS bleibt, sind Verschlüsselung auf dem Gerät, Backup und QR-Gerätewechsel, Erinnerungslogik und Produktreife (Abschnitt 5).
...
**Zweiter Ring (sekundär): iPhone-Nutzer in Mischhaushalten und Umsteiger von Apple Journal.** Sie kommen über den Gerätewechsel iOS↔Android (D6), über den Export aus dem Apple-Journal-ZIP und über den Ärger mit fehlender deutscher Transkription und iCloud-Bindung [5][17][18]. Gegenüber DailyVox, das dieselben Nutzer kostenlos bedient, muss der iOS-Teil die vier Unterschiede aus Abschnitt 5 sichtbar machen; wer nur ein kostenloses lokales Diktat-Tagebuch sucht, ist dort gut aufgehoben, und das Konzept sollte das nicht bestreiten [62]. Der iOS-Teil ist technisch günstig (D2) und bleibt Teil des MVP (M9); er ist aber nicht der Ort, an dem die App zuerst gefunden wird.

**Später:** Menschen mit Schreibhürden, Schweizer Mundart, Praxen und Coaches (Zielgruppentabelle und Go-to-Market-Reihenfolge in `07-geschaeftsmodell.md`, Abschnitte 2 und 7.1, sind auf diese Reihenfolge auszurichten). Für Schweizer Mundart gilt zusätzlich: Die einzigen feinabgestimmten Schweizerdeutsch-Modelle (Whisper large-v3 mit WER 13,31, large-v3-turbo mit rund 1,6 GB) stehen unter CC-BY-NC-4.0 und sind für ein kommerzielles Produkt nicht nutzbar; das stützt D12, Mundart nicht zu versprechen [62][65].
...
|---|---|---|
| Aufnahmen gehen bei Upload-Fehlern verloren | Voicenotes [38] | kein Upload; Aufnahme wird lokal in verschlüsselten 32-KiB-Chunks geschrieben, jeder Chunk einzeln authentifiziert, ohne Klartext-Zwischendatei (D4) [66] |
...
| Backup-Datei unauffindbar; Backup nach OS-Update gebrochen; Cloud-Restore meldet Erfolg, ist aber unvollständig (häufigste echte Play-Store-Beschwerden) | Easy Diary, StoryPad (vom Entwickler archivierte Rezensionen) [62][67] | Speicherort der Backup- und Transferdatei wird angezeigt und über das System-Teilen-Blatt gewählt; Wiederherstellungstest im Onboarding; Container prüft Version und Manifest-Hash vor dem Import (D6) |
| Aussperrung aus dem Tagebuch nach Änderung der Biometrie | Easy Diary [62][67] | Gerätecode als zweiter Weg neben Biometrie; Passphrase-Backup als Wiederherstellungspfad, der nicht am Gerät hängt (D5, D6) |
| Deutsches Diktat trennt Komposita und setzt Leerzeichen um Bindestriche | Apple-Diktat, damit auch das Diktat von Diarium auf iOS [62][68] | deutsche Testsätze mit Komposita, Bindestrichen und gesprochener Interpunktion in der Abnahme der Transkription (D2, D3) |
| Tagebuchinhalt im App-Switcher sichtbar; Medien landen in der Google-Fotos-Sicherung | Easy Diary, One Second Diary [62] | Privacy-Overlay und FLAG_SECURE; Audio nur verschlüsselt im App-Speicher, nie in öffentlichen Medienordnern (D4, D5) |
| Kostenloser lokaler Wettbewerber ohne belegte Verschlüsselung der Einträge, ohne Gerätewechsel außerhalb von iCloud, mit Wochenzielen | DailyVox [13][62] | Verschlüsselung auf dem Gerät, QR-Gerätewechsel und tägliche Erinnerung ohne Streak als sichtbare iOS-Unterschiede (D5, D6, D7) |
...
1. Store-Prüfung aller Preise, Sterne und Bewertungszahlen in Abschnitt 4 (App Store DE/CH/AT, Google Play), insbesondere CortexOS, Offscript, Flint, DailyVox, Voice Journal, EchoVault, Murmeln; Store-IDs und Abrufmuster stehen in `docs/recherche/nachrecherche-nutzerstimmen-stores.md`, Abschnitt 6 [62].
...
5. Kommt eine Android-Version von DailyVox? Stand September 2026 gibt es nur eine Nutzeranfrage (Issue #4, 3. August 2026) und keine Ankündigung des Entwicklers; der Issue-Tracker ist zu beobachten, weil eine Android-Version den Brückenkopf direkt träfe [63].
...
7. Euro-Preise von Day One, Journey, Diarium, Diarly, Daylio in den DACH-Stores; für Diarium den Widerspruch zwischen "knapp 10 Euro" in einer deutschen Rezension und 14,99 $ (US) klären [62].
8. Wörtliche Rezensionen (DE/AT/CH) zu Sync-Ausfällen, Datenverlust und Abo-Ärger bei Day One, Journey, Apple Journal; die vorliegende Stichprobe (neun deutschsprachige Rezensionsfragmente aus Suchsnippets, vom Entwickler archivierte Play-Rezensionen, GitHub-Issue-Tracker) ist technisch verzerrt und erreicht das Ziel von 30 deutschen Originalzitaten nicht; das Vorgehen für eine Sitzung ohne Store-Sperre steht in `docs/recherche/nachrecherche-nutzerstimmen-stores.md`, Abschnitt 6 [62].
...
62. Nachrecherche Nutzerstimmen und Store-Kennzahlen DE/AT/CH (Stand 3. 9. 2026): `docs/recherche/nachrecherche-nutzerstimmen-stores.md` (Abschnitt 1.3 archivierte Play-Rezensionen, Abschnitt 3 Schweizerdeutsch-Modelle, Abschnitt 4 DailyVox und neue Listings, Abschnitt 6 Abrufmuster)
63. DailyVox, Issue #4 "Any plans for Android Release?" (3. 8. 2026): https://github.com/intrepidkarthi/dailyvox/issues/4
64. apple-journal-cli (Apple Journal speichert Einträge lokal als RTF in `moments.sqlite` ohne Verschlüsselung): https://github.com/omarshahine/apple-journal-cli
65. Transkribor, Issue #130 zu Schweizerdeutsch-Fine-Tunes (apexAI-Switzerland large-v3 WER 13,31, CC-BY-NC-4.0; 11. 8. 2026): https://github.com/napoleonmm83/Transkribor/issues/130
66. Nachrecherche Audio-Container, Aufnahme-Pipeline und Wiedergabe (Stand 3. 9. 2026; AAC-LC/M4A im MVP, Chunk-AEAD nach Cryptomator-Muster): `docs/recherche/nachrecherche-audio-container.md`
67. Easy Diary, vom Entwickler archivierte Play-Store-Rezensionen zu Backup und Aussperrung: https://github.com/hanjoongcho/aaf-easydiary/issues/184 ; https://github.com/hanjoongcho/aaf-easydiary/issues/200 ; https://github.com/hanjoongcho/aaf-easydiary/issues/197 ; https://github.com/hanjoongcho/aaf-easydiary/issues/111 ; StoryPad, unvollständiger Drive-Restore: https://github.com/theachoem/storypad/issues/611
68. Apple Developer Forums, Thread 826756 "Dictation in German has a couple of persistent bugs" (Mai 2026): https://developer.apple.com/forums/thread/826756
